#!/bin/bash
#SBATCH --account=NN9535K --job-name=63016915
...
/cluster/home/farhadvadiee/2023/jan13/TreeWidzard-Engine-main/Build/./treewidzard -atp  tw = 4 -pl -premise -nthreads 64 ParallelIsomorphismBreadthFirstSearch ../../inputs/d_2.txt > /cluster/projects/nn9535k/farhad/2023/conjectures/Reed/jan13/tw1To4/main-script/job-generation/../../program-outputs/tw4_d_2_core_32_premise_pibfs_63016915.txt
exit 0
