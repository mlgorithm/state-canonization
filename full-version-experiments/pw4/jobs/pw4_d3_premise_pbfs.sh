...
#SBATCH --job-name=pw4_d3_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 4 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_3.txt > outputs/pw4_d3_premise_pbfs.txt
