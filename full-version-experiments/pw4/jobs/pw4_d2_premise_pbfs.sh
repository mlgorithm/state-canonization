...
#SBATCH --job-name=pw4_d2_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 4 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_2.txt > outputs/pw4_d2_premise_pbfs.txt
