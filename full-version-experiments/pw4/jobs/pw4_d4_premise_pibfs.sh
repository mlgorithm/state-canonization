...
#SBATCH --job-name=pw4_d4_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 4 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_4.txt > outputs/pw4_d4_premise_pibfs.txt
