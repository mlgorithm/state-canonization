...
#SBATCH --job-name=pw4_d5_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 4 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_5.txt > outputs/pw4_d5_premise_pibfs.txt
