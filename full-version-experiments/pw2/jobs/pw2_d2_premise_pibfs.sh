...
#SBATCH --job-name=pw2_d2_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 2 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_2.txt > outputs/pw2_d2_premise_pibfs.txt
