...
#SBATCH --job-name=pw2_d3_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 2 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_3.txt > outputs/pw2_d3_premise_pibfs.txt
