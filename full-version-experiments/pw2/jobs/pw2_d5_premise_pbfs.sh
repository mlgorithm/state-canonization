...
#SBATCH --job-name=pw2_d5_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 2 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_5.txt > outputs/pw2_d5_premise_pbfs.txt
