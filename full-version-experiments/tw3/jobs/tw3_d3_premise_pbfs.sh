...
#SBATCH --job-name=tw3_d3_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_3.txt > outputs/tw3_d3_premise_pbfs.txt
