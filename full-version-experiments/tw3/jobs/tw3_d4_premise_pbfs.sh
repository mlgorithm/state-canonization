...
#SBATCH --job-name=tw3_d4_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_4.txt > outputs/tw3_d4_premise_pbfs.txt
