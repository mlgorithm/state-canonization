...
#SBATCH --job-name=tw3_d4_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp tw = 3 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_4.txt > outputs/tw3_d4_premise_pibfs.txt
