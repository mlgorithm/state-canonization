...
#SBATCH --job-name=tw3_d5_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_5.txt > outputs/tw3_d5_premise_pbfs.txt
