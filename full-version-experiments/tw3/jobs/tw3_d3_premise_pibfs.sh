...
#SBATCH --job-name=tw3_d3_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp tw = 3 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_3.txt > outputs/tw3_d3_premise_pibfs.txt
