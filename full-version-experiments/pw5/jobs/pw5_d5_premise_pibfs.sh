...
#SBATCH --job-name=pw5_d5_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 5 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_5.txt > outputs/pw5_d5_premise_pibfs.txt
