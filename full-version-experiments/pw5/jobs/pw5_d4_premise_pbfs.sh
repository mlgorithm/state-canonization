...
#SBATCH --job-name=pw5_d4_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 5 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_4.txt > outputs/pw5_d4_premise_pbfs.txt
