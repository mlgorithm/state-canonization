...
#SBATCH --job-name=pw5_d3_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 5 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_3.txt > outputs/pw5_d3_premise_pbfs.txt
