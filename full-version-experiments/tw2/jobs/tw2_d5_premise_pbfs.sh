...
#SBATCH --job-name=tw2_d5_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 2 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_5.txt > outputs/tw2_d5_premise_pbfs.txt
