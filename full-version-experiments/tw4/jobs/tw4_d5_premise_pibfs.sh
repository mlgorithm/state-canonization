...
#SBATCH --job-name=tw4_d5_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp tw = 4 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_5.txt > outputs/tw4_d5_premise_pibfs.txt
