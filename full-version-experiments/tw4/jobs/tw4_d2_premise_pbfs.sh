...
#SBATCH --job-name=tw4_d2_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 4 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_2.txt > outputs/tw4_d2_premise_pbfs.txt
