...
#SBATCH --job-name=pw1_d4_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 1 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_4.txt > outputs/pw1_d4_premise_pibfs.txt
