...
#SBATCH --job-name=pw1_d4_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 1 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_4.txt > outputs/pw1_d4_premise_pbfs.txt
