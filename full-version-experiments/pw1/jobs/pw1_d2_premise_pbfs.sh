...
#SBATCH --job-name=pw1_d2_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 1 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_2.txt > outputs/pw1_d2_premise_pbfs.txt
