...
#SBATCH --job-name=pw1_d3_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 1 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_3.txt > outputs/pw1_d3_premise_pibfs.txt
