...
#SBATCH --job-name=pw3_d4_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_4.txt > outputs/pw3_d4_premise_pbfs.txt
