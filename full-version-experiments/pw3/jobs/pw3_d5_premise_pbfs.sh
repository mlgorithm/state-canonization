...
#SBATCH --job-name=pw3_d5_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_5.txt > outputs/pw3_d5_premise_pbfs.txt
