...
#SBATCH --job-name=pw3_d2_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_2.txt > outputs/pw3_d2_premise_pbfs.txt
