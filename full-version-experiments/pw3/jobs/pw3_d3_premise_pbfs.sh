...
#SBATCH --job-name=pw3_d3_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp pw = 3 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_3.txt > outputs/pw3_d3_premise_pbfs.txt
