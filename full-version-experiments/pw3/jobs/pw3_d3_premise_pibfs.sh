...
#SBATCH --job-name=pw3_d3_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp pw = 3 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_3.txt > outputs/pw3_d3_premise_pibfs.txt
