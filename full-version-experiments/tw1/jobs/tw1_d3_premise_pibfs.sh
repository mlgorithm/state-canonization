...
#SBATCH --job-name=tw1_d3_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp tw = 1 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_3.txt > outputs/tw1_d3_premise_pibfs.txt
