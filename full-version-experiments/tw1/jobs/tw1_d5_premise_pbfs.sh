...
#SBATCH --job-name=tw1_d5_premise_pbfs
...
"${TREEWIDZARD_BIN}" -atp tw = 1 -pl -premise -nthreads 32 ParallelBreadthFirstSearch properties/d_5.txt > outputs/tw1_d5_premise_pbfs.txt
