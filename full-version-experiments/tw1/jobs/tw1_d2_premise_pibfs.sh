...
#SBATCH --job-name=tw1_d2_premise_pibfs
...
"${TREEWIDZARD_BIN}" -atp tw = 1 -pl -premise -nthreads 32 ParallelIsomorphismBreadthFirstSearch properties/d_2.txt > outputs/tw1_d2_premise_pibfs.txt
